// Crucix Configuration â all settings with env var overrides
...
export default {
  ...
  // Delta engine thresholds â override defaults from lib/delta/engine.mjs
  ...
  delta: {
    thresholds: {
      ...
      count: {
        // urgent_posts: 3,     // need Â±3 urgent posts to flag
        // thermal_total: 1000, // need Â±1000 thermal detections
      },
    },
  },
};
