// Delta Engine v2 â compares two synthesized sweep results and produces structured changes
// Improvements: count metric thresholds, semantic TG dedup, configurable thresholds, null-safety

import { createHash } from 'crypto';

// âââ Default Thresholds ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
const DEFAULT_COUNT_THRESHOLDS = {
  urgent_posts: 2,         // need Â±2 to matter (was 0 â any change)
  thermal_total: 500,      // Â±500 detections (was 0 â +1 was noise)
  air_total: 50,           // Â±50 aircraft
  who_alerts: 1,           // any new WHO alert matters
  conflict_events: 5,      // Â±5 ACLED events
  conflict_fatalities: 10,  // Â±10 fatalities
  sdr_online: 3,           // Â±3 receivers
  news_count: 5,           // Â±5 news items
  sources_ok: 1,           // any source going down matters
};

// âââ Metric Definitions ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Semantic Hashing for Telegram Posts âââââââââââââââââââââââââââââââââââââ

/**
 * Produce a normalized hash of a post's content.
 * Strips timestamps, normalizes numbers, lowercases â so "BREAKING: 5 missiles at 14:32"
...
// âââ Core Delta Computation ââââââââââââââââââââââââââââââââââââââââââââââââââ
...
export function computeDelta(current, previous, thresholdOverrides = {}) {
  ...
  // âââ Numeric metrics: track % change âââââââââââââââââââââââââââââââââ
  ...
  // âââ Count metrics: track absolute change (with minimum thresholds) ââ
  ...
  // âââ New urgent Telegram posts (semantic dedup) ââââââââââââââââââââââ
  ...
  // âââ Nuclear anomaly state change ââââââââââââââââââââââââââââââââââââ
  ...
  // âââ Source health degradation âââââââââââââââââââââââââââââââââââââââ
  ...
  // âââ Overall direction âââââââââââââââââââââââââââââââââââââââââââââââ
